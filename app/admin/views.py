...
class ConsumerProfileAdmin(BaseAdminView, model=ConsumerProfile):
    ...
    column_list = [
        ConsumerProfile.id,
        ConsumerProfile.user_id,
        ConsumerProfile.nickname,
        ConsumerProfile.created_at,
    ]
...
class SharedProductAdmin(BaseAdminView, model=SharedProduct):
    ...
    column_list = [
        SharedProduct.id,
        SharedProduct.name,
        SharedProduct.merchant_id,
        SharedProduct.category_id,
        SharedProduct.current_price,
        SharedProduct.stock,
...
class AdCampaignAdmin(BaseAdminView, model=AdCampaign):
    ...
    column_list = [
        AdCampaign.id,
        AdCampaign.name,
        AdCampaign.merchant_id,
        AdCampaign.status,
        AdCampaign.daily_budget,
        AdCampaign.total_budget,
